#!/usr/bin/env  python
# Original at https://github.com/kovidgoyal/calibre/blob/master/recipes/economist.recipe
import json
import time
...
class Economist(BasicNewsRecipe):
    ...
    description = 'Global news and current affairs from a European perspective. Best downloaded away from Friday to avoid being blocked.'
    extra_css = '''
        em { color:#202020; }
    ...
    def parse_index(self):
        ...
        if not ans:
            ...
            try:
                ans = self.economist_parse_graphql_index(self.economist_get_edition(edition_date))
            except Exception as e:
